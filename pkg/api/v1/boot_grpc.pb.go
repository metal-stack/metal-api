...
type BootServiceClient interface {
	...
	Wait(ctx context.Context, in *BootServiceWaitRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[BootServiceWaitResponse], error)
...
func (c *bootServiceClient) Dhcp(ctx context.Context, in *BootServiceDhcpRequest, opts ...grpc.CallOption) (*BootServiceDhcpResponse, error) {
	...
	err := c.cc.Invoke(ctx, BootService_Dhcp_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bootServiceClient) Boot(ctx context.Context, in *BootServiceBootRequest, opts ...grpc.CallOption) (*BootServiceBootResponse, error) {
	...
	err := c.cc.Invoke(ctx, BootService_Boot_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bootServiceClient) SuperUserPassword(ctx context.Context, in *BootServiceSuperUserPasswordRequest, opts ...grpc.CallOption) (*BootServiceSuperUserPasswordResponse, error) {
	...
	err := c.cc.Invoke(ctx, BootService_SuperUserPassword_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bootServiceClient) Register(ctx context.Context, in *BootServiceRegisterRequest, opts ...grpc.CallOption) (*BootServiceRegisterResponse, error) {
	...
	err := c.cc.Invoke(ctx, BootService_Register_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bootServiceClient) Wait(ctx context.Context, in *BootServiceWaitRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[BootServiceWaitResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &BootService_ServiceDesc.Streams[0], BootService_Wait_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[BootServiceWaitRequest, BootServiceWaitResponse]{ClientStream: stream}
...
type BootService_WaitClient = grpc.ServerStreamingClient[BootServiceWaitResponse]
...
func (c *bootServiceClient) Report(ctx context.Context, in *BootServiceReportRequest, opts ...grpc.CallOption) (*BootServiceReportResponse, error) {
	...
	err := c.cc.Invoke(ctx, BootService_Report_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bootServiceClient) AbortReinstall(ctx context.Context, in *BootServiceAbortReinstallRequest, opts ...grpc.CallOption) (*BootServiceAbortReinstallResponse, error) {
	...
	err := c.cc.Invoke(ctx, BootService_AbortReinstall_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BootServiceServer interface {
	...
	// Wait is a hanging call that waits until the machine gets allocated by a user
	Wait(*BootServiceWaitRequest, grpc.ServerStreamingServer[BootServiceWaitResponse]) error
	// Report tells metal-api installation was either successful or failed
...
// UnimplementedBootServiceServer should be embedded to have
...
func (UnimplementedBootServiceServer) Wait(*BootServiceWaitRequest, grpc.ServerStreamingServer[BootServiceWaitResponse]) error {
...
func (UnimplementedBootServiceServer) testEmbeddedByValue() {}
...
func RegisterBootServiceServer(s grpc.ServiceRegistrar, srv BootServiceServer) {
	// If the following call pancis, it indicates UnimplementedBootServiceServer was
...
func _BootService_Wait_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(BootServiceServer).Wait(m, &grpc.GenericServerStream[BootServiceWaitRequest, BootServiceWaitResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type BootService_WaitServer = grpc.ServerStreamingServer[BootServiceWaitResponse]
