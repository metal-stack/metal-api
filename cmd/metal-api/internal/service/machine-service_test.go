	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			for wantNetworkID, wantNetwork := range tt.want {
				...
				require.Equal(t, wantNetwork.private, gotNetwork.private)
				require.Equal(t, wantNetwork.privatePrimary, gotNetwork.privatePrimary)
				require.Equal(t, wantNetwork.auto, gotNetwork.auto)
				require.Equal(t, wantNetwork.shared, gotNetwork.shared)
