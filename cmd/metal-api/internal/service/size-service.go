...
func (r sizeResource) webService() *restful.WebService {
	...
	ws.Route(ws.GET("/sizeimageconstraints").
		...
		Operation("listSizeSizeImageConstraints").
...
func (r sizeResource) listSizeImageConstraints(request *restful.Request, response *restful.Response) {
...
func (r sizeResource) createSizeImageConstraint(request *restful.Request, response *restful.Response) {
...
func (r sizeResource) deleteSizeImageConstraint(request *restful.Request, response *restful.Response) {
	id := request.PathParameter("id")
...
func (r sizeResource) updateSizeImageConstraint(request *restful.Request, response *restful.Response) {
