...
type FirewallEgressRule struct {
	...
	Ports    []int    `json:"ports,omitempty" description:"the ports affected by this rule"`
	To       []string `json:"to,omitempty" description:"the cidrs affected by this rule"`
...
type FirewallIngressRule struct {
	...
	From     []string `json:"from,omitempty" description:"the cidrs affected by this rule"`
	Comment  string   `json:"comment,omitempty" description:"an optional comment describing what this rule is used for" optional:"true"`
}
