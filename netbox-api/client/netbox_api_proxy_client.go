...
import (
	...
	"git.f-i-ts.de/cloud-native/metal/metal-api/netbox-api/client/ips"
	"git.f-i-ts.de/cloud-native/metal/metal-api/netbox-api/client/machines"
	"git.f-i-ts.de/cloud-native/metal/metal-api/netbox-api/client/networks"
...
func New(transport runtime.ClientTransport, formats strfmt.Registry) *NetboxAPIProxy {
	...
	cli.Ips = ips.New(transport, formats)
