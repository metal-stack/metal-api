...
func StartMeili(t testing.TB) (container testcontainers.Container, c *ConnectionDetails, err error) {
	ctx := context.Background()
	var log testcontainers.Logging
	if t != nil {
		log = testcontainers.TestLogger(t)
	...
	ip, err := meiliContainer.Host(ctx)
	if err != nil {
